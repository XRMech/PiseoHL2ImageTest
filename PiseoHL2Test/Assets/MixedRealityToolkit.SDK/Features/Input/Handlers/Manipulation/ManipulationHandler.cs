...
namespace Microsoft.MixedReality.Toolkit.UI
{
	...
	public class ManipulationHandler : MonoBehaviour, IMixedRealityPointerHandler, IMixedRealityFocusChangedHandler
	{
		...
		public ClickEvent OnClickStart = new ClickEvent();
		public ClickEvent OnClickEnd = new ClickEvent();
		//
		#endregion
		...
		public int GetManipulationTouchCount() { return pointerIdToPointerMap.Count; }
        ...
        public void OnPointerDown(MixedRealityPointerEventData eventData)
        {
            ...
            if (pointerIdToPointerMap.Count > 0)
            {
				//OnClickStart?.Invoke(eventData.Handedness);
				OnClickStart?.Invoke();
        ...
        public void OnPointerUp(MixedRealityPointerEventData eventData)
        {
			...
			UpdateStateMachine();
			//OnClickEnd?.Invoke(eventData.Handedness);
			OnClickEnd?.Invoke();
			eventData.Use();
		}
