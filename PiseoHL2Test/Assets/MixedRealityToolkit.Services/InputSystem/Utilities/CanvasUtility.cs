...
namespace Microsoft.MixedReality.Toolkit.Input.Utilities
{
    ...
    public class CanvasUtility : MonoBehaviour, IMixedRealityPointerHandler
    {
        ...
        private void Start()
        {
            ...
            {
                Debug.LogWarning("World Space Canvas should have no camera set to work properly with Mixed Reality Toolkit. At runtime, they'll get their camera set automatically.");
            }
        }
